package br.com.archforge_java.infrastructure.interceptor;

import br.com.archforge_java.infrastructure.security.AuthenticatedUserProvider;
...
public class AuditListener {
    ...
    private void saveAudit(Object entity, String action, Object oldEntity) throws JsonProcessingException {
        String keycloakId = authenticatedUserProvider.getAuthenticatedUserId();
